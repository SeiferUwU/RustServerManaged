		...
		foreach (BaseEntity entityContent in entityContents)
		{
			...
			if ((bool)rigidbody && !rigidbody.isKinematic)
			{
				...
				if (snapToAxis)
				{
					...
					vector2 = ((!(Vector3.Angle(vector3, axisToSnapTo) < Vector3.Angle(vector3, -axisToSnapTo))) ? (-base.transform.TransformDirection(axisToSnapTo)) : base.transform.TransformDirection(axisToSnapTo));
				}
