...
public class RCon
{
	...
	public static void SendMessageToSubscribers(string message, int identifier = -1)
	{
		if (listenerNew != null)
		{
			string message2 = JsonConvert.SerializeObject(new Response
			{
