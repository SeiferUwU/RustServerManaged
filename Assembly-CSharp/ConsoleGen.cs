...
{
	public static ConsoleSystem.Command[] All = new ConsoleSystem.Command[1690]
	{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AdventCalendar.overrideAdventCalendarMonth = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AIInformationZone.UseSimpleLOSCheck = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BaseMetalDetector.DetectLongRangeTick = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BaseMetalDetector.DetectMinMovementDistance = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BaseMetalDetector.NearestDistanceTick = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BaseSiegeWeapon.outsideDecayMinutes = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BatteringRam.maxBuildingBlockGrade = str.ToInt();
			},
			Default = "2"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Beehive.updateHiveInterval = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Beehive.updateHiveStatsInterval = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Beehive.xpIncreasePerHoneycomb = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BeeSwarmAI.breakRange = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BeeSwarmAI.flameSettingDistance = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BeeSwarmAI.killWithoutTargetTime = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BeeSwarmAI.searchRange = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BeeSwarmAI.waterThreshold = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BeeSwarmMaster.amountToSpawn = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BeeSwarmMaster.killWithoutATargetTime = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BeeSwarmMaster.secondsBetweenSpawns = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Bike.doPlayerDamage = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Bike.motorbikeMonumentPopulation = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Bike.outsideDecayMinutes = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Bike.pedalMonumentPopulation = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Bike.pedalRoadsidePopulation = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Bike.playerDamageRagdollTheshold = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BradleyAPC.DeployAttackDistanceMax = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BradleyAPC.DeployHealthRangeMax = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BradleyAPC.DeployHealthRangeMin = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BradleyAPC.DeployInterval = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BradleyAPC.DeployOnDamageCheckInterval = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BradleyAPC.KillScientistsOnBradleyDeath = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BradleyAPC.MountAfterNotAttackedDuration = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BradleyAPC.MountAfterNotFiredDuration = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BradleyAPC.MountAfterNotTargetsDuration = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BradleyAPC.ScientistRedeploymentMinInterval = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BradleyAPC.UseSmokeGrenades = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BuriedItems.buriedItemWeight = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BuriedItems.buryItemChance = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BuriedItems.expiryTime = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BuriedItems.maxBuriedItems = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				CargoShip.cargo_escape_boat_rhib = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				CargoShip.dock_time = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				CargoShip.docking_debug = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				CargoShip.refresh_loot_on_dock = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				CargoShip.should_dock = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				CCTV_RC.CameraDisableSeconds = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				Admin.PlayerInfo[] rval = Admin.playerlist();
				arg.ReplyWithObject(rval);
			}
		},
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				Admin.PlayerIDInfo[] rval = Admin.playerlistids();
				arg.ReplyWithObject(rval);
			}
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.defaultInterpolationDelay = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_check_spawner_is_on_navmesh = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_spawn_on_junkpile = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.scientist_spawners_enabled = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.eye_distance_parented_mounted_forgiveness = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.impact_effect_distance_forgiveness = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.mesh_inside_check_distance = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.projectile_distance_forgiveness_minimum = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.projectile_trajectory_update = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.projectile_update_limit = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.rpc_timer_forgiveness = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.rpcstallfade = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.rpcstallmode = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.rpcstallthreshold = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.server_occlusion_admin_bypass = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.server_occlusion_blocked_grid_threshold = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.server_occlusion_caching = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.server_occlusion_disable_los = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.server_occlusion_disable_sleeper_los = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.server_occlusion_neighbour_threshold = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.server_occlusion_save_grid = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.server_occlusion_use_neighbour_thresholds = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			Name = "serverside_fall_damage",
			Parent = "antihack",
			FullName = "antihack.serverside_fall_damage",
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => ConVar.AntiHack.serverside_fall_damage.ToString(),
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.serverside_fall_damage = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.tick_buffer_noclip_threshold = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.tick_buffer_preventions = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.tick_buffer_reject_threshold = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.tick_max_distance = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.tick_max_distance_falling = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.tick_max_distance_parented = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.use_legacy_mesh_inside_check = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Chat.hideChatInTutorial = str.ToBool();
			},
			Default = "True"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Clan.editsRequireClanTable = str.ToBool();
			},
			Default = "true"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Clan.scoreForDestroyingBradley = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			Name = "scorefordestroyingtoolcupboards",
			Parent = "clan",
			FullName = "clan.scorefordestroyingtoolcupboards",
			ServerAdmin = true,
			Description = "How much score players earn for destroying other player's tool cupboards",
			Variable = true,
			GetOveride = delegate
			{
				int scoreForDestroyingToolCupboards = Clan.scoreForDestroyingToolCupboards;
				return (scoreForDestroyingToolCupboards < -1 || scoreForDestroyingToolCupboards > 127) ? scoreForDestroyingToolCupboards.ToString() : Memoized.IntToString.Get(scoreForDestroyingToolCupboards);
			},
			SetOveride = delegate(string str)
			{
				Clan.scoreForDestroyingToolCupboards = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Clan.scoreForHackingCrates = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			Name = "scoreforkilledbyplayerinotherclan",
			Parent = "clan",
			FullName = "clan.scoreforkilledbyplayerinotherclan",
			ServerAdmin = true,
			Description = "How much score players earn for being killed by a player in another clan (this value should be negative)",
			Variable = true,
			GetOveride = delegate
			{
				int scoreForKilledByPlayerInOtherClan = Clan.scoreForKilledByPlayerInOtherClan;
				return (scoreForKilledByPlayerInOtherClan < -1 || scoreForKilledByPlayerInOtherClan > 127) ? scoreForKilledByPlayerInOtherClan.ToString() : Memoized.IntToString.Get(scoreForKilledByPlayerInOtherClan);
			},
			SetOveride = delegate(string str)
			{
				Clan.scoreForKilledByPlayerInOtherClan = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			Name = "scoreforkillingplayerinotherclan",
			Parent = "clan",
			FullName = "clan.scoreforkillingplayerinotherclan",
			ServerAdmin = true,
			Description = "How much score players earn for killing a player in another clan",
			Variable = true,
			GetOveride = delegate
			{
				int scoreForKillingPlayerInOtherClan = Clan.scoreForKillingPlayerInOtherClan;
				return (scoreForKillingPlayerInOtherClan < -1 || scoreForKillingPlayerInOtherClan > 127) ? scoreForKillingPlayerInOtherClan.ToString() : Memoized.IntToString.Get(scoreForKillingPlayerInOtherClan);
			},
			SetOveride = delegate(string str)
			{
				Clan.scoreForKillingPlayerInOtherClan = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			Name = "scoreforkillingunarmedplayer",
			Parent = "clan",
			FullName = "clan.scoreforkillingunarmedplayer",
			ServerAdmin = true,
			Description = "How much score players earn for killing unarmed players (this value should be negative)",
			Variable = true,
			GetOveride = delegate
			{
				int scoreForKillingUnarmedPlayer = Clan.scoreForKillingUnarmedPlayer;
				return (scoreForKillingUnarmedPlayer < -1 || scoreForKillingUnarmedPlayer > 127) ? scoreForKillingUnarmedPlayer.ToString() : Memoized.IntToString.Get(scoreForKillingUnarmedPlayer);
			},
			SetOveride = delegate(string str)
			{
				Clan.scoreForKillingUnarmedPlayer = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Clan.scoreForLootingEliteCrate = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Clan.scoreForOpeningHackedCrates = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Clan.scoreForReachingCargoShip = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			ServerAdmin = true,
			Description = "How much score players earn for running the excavator",
			Variable = true,
			GetOveride = delegate
			{
			...
			SetOveride = delegate(string str)
			{
				Clan.scoreForRunningExcavator = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			Name = "download_paste",
			Parent = "copypaste",
			FullName = "copypaste.download_paste",
			ServerAdmin = true,
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg)
			{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Creative.alwaysOnEnabled = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Creative.bypassHoldToPlaceDuration = str.ToBool();
			},
			Default = "False"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Creative.freePlacement = str.ToBool();
			},
			Default = "False"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Creative.freeRepair = str.ToBool();
			},
			Default = "False"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Creative.unlimitedIo = str.ToBool();
			},
			Default = "False"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Debugging.printMissionSpeakInfo = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Debugging.puzzleResetTimeMultiplier = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Debugging.tutorial_start_cooldown = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.bracket_0_doorcount = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.bracket_0_doorfraction = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.bracket_1_doorcount = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.bracket_1_doorfraction = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.bracket_2_doorcount = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.bracket_2_doorfraction = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.bracket_3_doorfraction = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.build_twig_cost_multiplier = str.ToFloat();
			},
			Default = "1"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.upgrade_hqm_cost_multiplier = str.ToFloat();
			},
			Default = "1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.upgrade_hqm_enabled = str.ToBool();
			},
			Default = "True"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.upgrade_metal_cost_multiplier = str.ToFloat();
			},
			Default = "1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.upgrade_metal_enabled = str.ToBool();
			},
			Default = "True"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.upgrade_stone_cost_multiplier = str.ToFloat();
			},
			Default = "1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.upgrade_stone_enabled = str.ToBool();
			},
			Default = "True"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.upgrade_wood_cost_multiplier = str.ToFloat();
			},
			Default = "1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.upgrade_wood_enabled = str.ToBool();
			},
			Default = "True"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.use_door_upkeep_brackets = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			Parent = "demo",
			FullName = "demo.delete_after_upload",
			ServerAdmin = true,
			Saved = true,
			Description = "Should the full server demos be deleted after they are uploaded",
			Variable = true,
			GetOveride = () => Demo.DeleteDemoAfterUpload.ToString(),
			SetOveride = delegate(string str)
			{
				Demo.DeleteDemoAfterUpload = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			Name = "server_demo_cleanup_interval",
			Parent = "demo",
			FullName = "demo.server_demo_cleanup_interval",
			ServerAdmin = true,
			Saved = true,
			Description = "How many minutes between cleaning up demos from the disk",
			Variable = true,
			GetOveride = delegate
			{
				int demoDiskCleanupIntervalMinutes = Demo.DemoDiskCleanupIntervalMinutes;
				return (demoDiskCleanupIntervalMinutes < -1 || demoDiskCleanupIntervalMinutes > 127) ? demoDiskCleanupIntervalMinutes.ToString() : Memoized.IntToString.Get(demoDiskCleanupIntervalMinutes);
			},
			SetOveride = delegate(string str)
			{
				Demo.DemoDiskCleanupIntervalMinutes = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			Name = "max_upload_concurrency",
			Parent = "demo",
			FullName = "demo.max_upload_concurrency",
			ServerAdmin = true,
			Description = "Max parallel requests when uploading demos",
			Variable = true,
			GetOveride = delegate
			{
				int demoUploadConcurrency = Demo.DemoUploadConcurrency;
				return (demoUploadConcurrency < -1 || demoUploadConcurrency > 127) ? demoUploadConcurrency.ToString() : Memoized.IntToString.Get(demoUploadConcurrency);
			},
			SetOveride = delegate(string str)
			{
				Demo.DemoUploadConcurrency = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			Name = "server_demo_disk_space_gb",
			Parent = "demo",
			FullName = "demo.server_demo_disk_space_gb",
			ServerAdmin = true,
			Saved = true,
			Description = "How much disk space full server demos can take before we start to delete them",
			Variable = true,
			GetOveride = delegate
			{
				int maxDemoDiskSpaceGB = Demo.MaxDemoDiskSpaceGB;
				return (maxDemoDiskSpaceGB < -1 || maxDemoDiskSpaceGB > 127) ? maxDemoDiskSpaceGB.ToString() : Memoized.IntToString.Get(maxDemoDiskSpaceGB);
			},
			SetOveride = delegate(string str)
			{
				Demo.MaxDemoDiskSpaceGB = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			Name = "server_demo_directory",
			Parent = "demo",
			FullName = "demo.server_demo_directory",
			ServerAdmin = true,
			Description = "Directory to save full server demos",
			Variable = true,
			GetOveride = () => Demo.ServerDemoDirectory ?? "",
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			Name = "server_flush_seconds",
			Parent = "demo",
			FullName = "demo.server_flush_seconds",
			ServerAdmin = true,
			Saved = true,
			Variable = true,
			GetOveride = delegate
			{
				int serverDemoFlushInterval = Demo.ServerDemoFlushInterval;
				return (serverDemoFlushInterval < -1 || serverDemoFlushInterval > 127) ? serverDemoFlushInterval.ToString() : Memoized.IntToString.Get(serverDemoFlushInterval);
			},
			SetOveride = delegate(string str)
			{
				Demo.ServerDemoFlushInterval = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			Name = "full_server_demo",
			Parent = "demo",
			FullName = "demo.full_server_demo",
			ServerAdmin = true,
			Saved = true,
			Variable = true,
			GetOveride = () => Demo.ServerDemosEnabled.ToString(),
			SetOveride = delegate(string str)
			{
				Demo.ServerDemosEnabled = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			Name = "upload_bandwidth_limit_ratio",
			Parent = "demo",
			FullName = "demo.upload_bandwidth_limit_ratio",
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => Demo.UploadBandwidthLimitRatio.ToString(),
			SetOveride = delegate(string str)
			{
				Demo.UploadBandwidthLimitRatio = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			Name = "upload_demos",
			Parent = "demo",
			FullName = "demo.upload_demos",
			ServerAdmin = true,
			Saved = true,
			Variable = true,
			GetOveride = () => Demo.UploadDemos.ToString(),
			SetOveride = delegate(string str)
			{
				Demo.UploadDemos = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			Name = "upload_url",
			Parent = "demo",
			FullName = "demo.upload_url",
			ServerAdmin = true,
			Saved = true,
			Variable = true,
			GetOveride = () => Demo.UploadUrl ?? "",
			SetOveride = delegate(string str)
			{
				Demo.UploadUrl = str;
			}
		...
		new ConsoleSystem.Command
		{
			Name = "zip_demos",
			Parent = "demo",
			FullName = "demo.zip_demos",
			ServerAdmin = true,
			Saved = true,
			Description = "Should we be zipping the demos before we upload them",
			Variable = true,
			GetOveride = () => Demo.ZipServerDemos.ToString(),
			SetOveride = delegate(string str)
			{
				Demo.ZipServerDemos = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string rval = Entity.svspawngrid(arg.GetString(0), arg.GetInt(1, 5), arg.GetInt(2, 5), arg.GetInt(3, 5));
				arg.ReplyWithObject(rval);
			}
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Env.nightlight_brightness = str.ToFloat();
			},
			Default = "0.022"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Env.nightlight_distance = str.ToFloat();
			},
			Default = "7"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Env.nightlight_fadefraction = str.ToFloat();
			},
			Default = "0.65"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Global.job_system_threads = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			Name = "legacymonumentnotifications",
			Parent = "global",
			FullName = "global.legacymonumentnotifications",
			ServerAdmin = true,
			Description = "Forces old monument event notification behaviour (UI popup, no sounds)",
			Variable = true,
			GetOveride = () => Global.legacymonumentnotifications.ToString(),
			SetOveride = delegate(string str)
			{
				Global.legacymonumentnotifications = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Global.updateNetworkPositionWithDebugCameraWhileSpectating = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Inventory.stackable_item_ownership = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				object rval = ConVar.Manifest.PrintManifest();
				arg.ReplyWithObject(rval);
			}
		},
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				object rval = ConVar.Manifest.PrintManifestRaw();
				arg.ReplyWithObject(rval);
			}
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Net.network_group_debug = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				NPC_ConVars.vendor_attack_heli_enabled = str.ToBool();
			},
			Default = "True"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				NPC_ConVars.vendor_hab_enabled = str.ToBool();
			},
			Default = "True"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				NPC_ConVars.vendor_minicopter_enabled = str.ToBool();
			},
			Default = "True"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				NPC_ConVars.vendor_rhib_enabled = str.ToBool();
			},
			Default = "True"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				NPC_ConVars.vendor_rowboat_enabled = str.ToBool();
			},
			Default = "True"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				NPC_ConVars.vendor_scrap_heli_enabled = str.ToBool();
			},
			Default = "True"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				NPC_ConVars.vendor_sub_duo_enabled = str.ToBool();
			},
			Default = "True"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				NPC_ConVars.vendor_sub_solo_enabled = str.ToBool();
			},
			Default = "True"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => ConVar.Physics.allowhorsetempragdoll.ToString(),
			SetOveride = delegate(string str)
			{
				ConVar.Physics.allowhorsetempragdoll = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => ConVar.Physics.allowplayertempragdoll.ToString(),
			SetOveride = delegate(string str)
			{
				ConVar.Physics.allowplayertempragdoll = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			GetOveride = delegate
			{
				int droppedmode = ConVar.Physics.droppedmode;
		...
		new ConsoleSystem.Command
		{
			...
			GetOveride = delegate
			{
				int groundwatchfails = ConVar.Physics.groundwatchfails;
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				ConVar.Physics.print_colliders_per_cell(arg);
			}
		},
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				ConVar.Physics.print_colliders_per_prefab(arg);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Physics.serverragdollmode = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			ShowInAdminUI = true,
			Variable = true,
			GetOveride = () => ConVar.Physics.serversideragdolls.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			GetOveride = delegate
			{
				int solveriterationcount = ConVar.Physics.solveriterationcount;
		...
		new ConsoleSystem.Command
		{
			...
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => ConVar.Physics.towingmaxlinearaccelfromjoint.ToString(),
			SetOveride = delegate(string str)
			{
				ConVar.Physics.towingmaxlinearaccelfromjoint = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			ShowInAdminUI = true,
			Variable = true,
			GetOveride = () => ConVar.Physics.treecollision.ToString(),
			SetOveride = delegate(string str)
			{
				ConVar.Physics.treecollision = str.ToBool();
			},
			Default = "True"
		},
		new ConsoleSystem.Command
		{
			...
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => ConVar.Ping.auto_refresh_region.ToString(),
			SetOveride = delegate(string str)
			{
				ConVar.Ping.auto_refresh_region = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => ConVar.Ping.ping_estimate_logging.ToString(),
			SetOveride = delegate(string str)
			{
				ConVar.Ping.ping_estimate_logging = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => ConVar.Ping.ping_estimation.ToString(),
			SetOveride = delegate(string str)
			{
				ConVar.Ping.ping_estimation = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => ConVar.Ping.ping_parallel.ToString(),
			SetOveride = delegate(string str)
			{
				ConVar.Ping.ping_parallel = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			GetOveride = delegate
			{
				int ping_refresh_interval = ConVar.Ping.ping_refresh_interval;
			...
			SetOveride = delegate(string str)
			{
				ConVar.Ping.ping_refresh_interval = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Player.dropbackpackondeath = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Player.dropbackpackondowned = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Player.keepteaondeath = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				ConVar.Pool.reset_max_pool_counter(arg);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Render.show_building_blocked_server = str.ToBool();
			},
			Default = "True"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				reports.ExceptionReportMaxLength = str.ToInt();
			},
			Default = "600"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Sentry.debugPreventDuplicates = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Sentry.maxinterference = str.ToInt();
			},
			Default = "12"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.allowSorting = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.allowVineSwinging = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.autoUploadMap = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.autoUploadMapImages = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.compassenabled = str.ToBool();
			},
			Default = "True"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.DestroyTaskBatchCount = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.drawpuzzleresets = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.emojiOwnershipCheck = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.farmChickenLocalAvoidance = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.fogofwar = str.ToBool();
			},
			Default = "False"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.fogofwarrevealsize = str.ToInt();
			},
			Default = "256"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.foodSpoiling = str.ToBool();
			},
			Default = "True"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.foodSpoilingBudgetMs = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.hardcoreFirearmAmmunitionCraftingMultiplier = str.ToFloat();
			},
			Default = "1"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.hideplayermapdirection = str.ToBool();
			},
			Default = "False"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.hideplayeronmap = str.ToBool();
			},
			Default = "False"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.homingMissileTargetsHab = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.hopperAnimationBudgetMs = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.http_connection_limit = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.industrialAllowQuickMove = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.industrialTransferStrictTimeLimits = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.itemdespawn_container_max_multiplier = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.long_distance_sounds = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.lowPriorityBuoyancyRange = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.mapenabled = str.ToBool();
			},
			Default = "True"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.max_explosive_protection = str.ToFloat();
			},
			Default = "0.75"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.maxFoodSpoilTimeDiffForItemStack = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.monumentPuzzleResetRadiation = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.monumentPuzzleResetRadiationAmount = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.monumentPuzzleResetRadiationMaxRadiusIncrease = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.monumentPuzzleResetRadiationPlayerEmptyTime = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.monumentPuzzleResetRadiationPreResetTime = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.monumentPuzzleResetRadiationRadiusMultiplier = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.monumentPuzzleResetWarnings = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.normalisedFoodSpoilTimeStackThreshold = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.npcAmmoLootMultiplier = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.oilrig_radiation_alarm_threshold = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.oilrig_radiation_amount_scale = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.oilrig_radiation_time_scale = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			ServerAdmin = true,
			Description = "Should indusrial be paused during autosaves",
			Variable = true,
			GetOveride = () => ConVar.Server.pauseindustrialduringsave.ToString(),
			SetOveride = delegate(string str)
			{
				ConVar.Server.pauseindustrialduringsave = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.pauseunlootedpuzzles = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.player_state_cache_size = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.premium = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.premiumRecheckInterval = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.premiumRecheckMaxBatchSize = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.premiumRecheckMinSeconds = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.pveBulletDamageMultiplier = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.pvp_ttk_bullet = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.pvp_ttk_global = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.pvp_ttk_melee = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.pvpBulletDamageMultiplier = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.rejoin_delay = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.respawnTimeAdditionBag = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.respawnTimeAdditionBed = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.saveframebudget = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.skipDeathScreenFade = str.ToBool();
			},
			Default = "False"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.SnapshotTaskBatchCount = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.spawnVineTrees = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.strictauth_eac = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.strictauth_steam = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.tutorialEnabled = str.ToBool();
			},
			Default = "false"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.useLegacySprinklerLoadProcess = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.useLegacyWorkbenchInteraction = str.ToBool();
			},
			Default = "False"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			ServerAdmin = true,
			Description = "Player Update parallelism mode. 0 - serial(def); 1 - burst jobs; 2 - 1 + managed tasks",
			Variable = true,
			GetOveride = delegate
			{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.UsePlayerUpdateJobs = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.waterWellNpcSalesRefreshFrequency = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.workbenchTaxRate1 = str.ToFloat();
			},
			Default = "0"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.workbenchTaxRate2 = str.ToFloat();
			},
			Default = "0"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.workbenchTaxRate3 = str.ToFloat();
			},
			Default = "0"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Stability.log_ground_missing_death = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Stability.log_stability_death = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Stability.log_stability_updates = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			GetOveride = delegate
			{
				int cl_maxstepsperframe = ConVar.Time.cl_maxstepsperframe;
			...
			SetOveride = delegate(string str)
			{
				ConVar.Time.cl_maxstepsperframe = str.ToInt();
			},
			Default = "2"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			Replicated = true,
			Variable = true,
			GetOveride = () => ConVar.Time.missiontimerscale.ToString(),
			SetOveride = delegate(string str)
			{
				ConVar.Time.missiontimerscale = str.ToFloat();
			},
			Default = "1"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			GetOveride = delegate
			{
				int sv_maxstepsperframe = ConVar.Time.sv_maxstepsperframe;
			...
			SetOveride = delegate(string str)
			{
				ConVar.Time.sv_maxstepsperframe = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => ConVar.Tree.simplified_collider.ToString(),
			SetOveride = delegate(string str)
			{
				ConVar.Tree.simplified_collider = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				vehicle.disable_wheels_when_sleeping = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.ambient_light_multiplier = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.arctic_fog_ambient_intensity_mult = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.arctic_fog_light_boost_mult = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.arctic_fog_ramp_end = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.arctic_fog_ramp_start = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.arid_fog_ambient_intensity_mult = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.arid_fog_light_boost_mult = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.arid_fog_ramp_end = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.arid_fog_ramp_start = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.atmosphere_fog_height_falloff = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.atmosphere_fog_ramp_end_distance = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.atmosphere_fog_ramp_start_distance = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.biome_fog_ambient_saturation_mult = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.biome_fog_distance_curve = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.cloud_config = str.ToInt();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.directional_light_multiplier = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.fog_multiplier = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.jungle_fog_ambient_intensity_mult = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.jungle_fog_light_boost_mult = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.jungle_fog_ramp_end = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.jungle_fog_ramp_start = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.moon_mesh_brightness_multiplier = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.reflection_multiplier = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.sun_mesh_brightness_multiplier = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.temperate_fog_ambient_intensity_mult = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.temperate_fog_light_boost_mult = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.temperate_fog_ramp_end = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.temperate_fog_ramp_start = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.tundra_fog_ambient_intensity_mult = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.tundra_fog_light_boost_mult = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.tundra_fog_ramp_end = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.tundra_fog_ramp_start = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.vclouds_moon_color_scale = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.vclouds_sun_color_scale = str.ToFloat();
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConvarTimedPrefabSpawner.prefab_despawn_time = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConvarTimedPrefabSpawner.prefab_spawn_interval = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConvarTimedPrefabSpawner.prefab_spawn_interval_variance = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConvarTimedPrefabSpawner.prefab_spawn_random_position_offset = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConvarTimedPrefabSpawner.prefab_spawn_random_rotation = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Drone.disableSamTargeting = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				DroppedItem.underwater_drag_budget_ms = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				EggHuntEvent.includeBots = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			Parent = "rcon",
			FullName = "rcon.clear_subscribers",
			ServerAdmin = true,
			Description = "Clears all subscribers from the server.",
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Parent = "rcon",
			FullName = "rcon.enablesubscriptions",
			ServerAdmin = true,
			Saved = true,
			Description = "If true, allow RCON connections to subscribe to server events. This could be a performance hit and should only be used if you need it.",
			ShowInAdminUI = true,
			Variable = true,
			GetOveride = () => RCon.EnableSubscriptions.ToString(),
			SetOveride = delegate(string str)
			{
				RCon.EnableSubscriptions = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			Name = "subscribe",
			Parent = "rcon",
			FullName = "rcon.subscribe",
			ServerAdmin = true,
			Description = "Un/Subscribes the current RCON connection to changes in server state. This could be a performance hit and should only be used if you need it.",
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg)
			{
				RCon.subscribe(arg);
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Facepunch.Rcon.Listener.BanDuration = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Facepunch.Rcon.Listener.LogFailedAttempts = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Facepunch.Rcon.Listener.MaxPasswordFailures = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Facepunch.Rcon.Listener.PermanentBanFailedIPs = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Analytics.GameplayAnalyticsConVar = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Analytics.GameplayRpcAnalyticsConVar = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Analytics.GameplayTickAnalyticsConVar = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			ServerAdmin = true,
			RconOnly = true,
			Description = "Shows how many analytics events are pending upload",
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg)
			{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Analytics.ServerPerformanceConVar = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			Name = "small_buffer_send_limit",
			Parent = "analytics",
			FullName = "analytics.small_buffer_send_limit",
			ServerAdmin = true,
			RconOnly = true,
			Saved = true,
			Description = "Size of analytics events, in bytes, that we try to send off using the same task thread. To disable, set to -1",
			Variable = true,
			GetOveride = delegate
			{
				int smallBufferSendLimit = Analytics.SmallBufferSendLimit;
				return (smallBufferSendLimit < -1 || smallBufferSendLimit > 127) ? smallBufferSendLimit.ToString() : Memoized.IntToString.Get(smallBufferSendLimit);
			},
			SetOveride = delegate(string str)
			{
				Analytics.SmallBufferSendLimit = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			Name = "usev2",
			Parent = "analytics",
			FullName = "analytics.usev2",
			ServerAdmin = true,
			Client = true,
			Variable = true,
			GetOveride = () => Analytics.UseV2.ToString(),
			SetOveride = delegate(string str)
			{
				Analytics.UseV2 = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RuntimeProfiler.command_lagspike_threshold = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RuntimeProfiler.profiling_entities = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RuntimeProfiler.profiling_entity_count_interval = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RuntimeProfiler.profiling_fixed_invokes = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RuntimeProfiler.profiling_invokes = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RuntimeProfiler.profiling_lagspikes = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RuntimeProfiler.profiling_packets = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RuntimeProfiler.profiling_ping = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RuntimeProfiler.profiling_ping_interval = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RuntimeProfiler.profiling_ping_per_frame = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RuntimeProfiler.profiling_rcon = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RuntimeProfiler.profiling_rcon_message_length = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RuntimeProfiler.profiling_work_queue = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RuntimeProfiler.rcon_lagspike_threshold = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RuntimeProfiler.rpc_lagspike_threshold = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RuntimeProfiler.runtime_profiling = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RuntimeProfiler.runtime_profiling_interval = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RuntimeProfiler.runtime_profiling_persist = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RuntimeProfiler.runtime_profiling_pool_flush_interval = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RuntimeProfiler.runtime_profiling_pooling = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			Name = "runtime_profiling_uploader_pooling",
			Parent = "profile",
			FullName = "profile.runtime_profiling_uploader_pooling",
			ServerAdmin = true,
			RconOnly = true,
			Description = "Should analytics bulk uploaders use pooling",
			Variable = true,
			GetOveride = () => RuntimeProfiler.runtime_profiling_uploader_pooling.ToString(),
			SetOveride = delegate(string str)
			{
				RuntimeProfiler.runtime_profiling_uploader_pooling = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				TickLogging.tick_uploader_lifetime = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				GameModeSoftcore.reclaim_building_auth = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				GameModeSoftcore.reclaim_suicide = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Handcuffs.maxConditionRepairLossOnPush = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Handcuffs.restrainedPushDamage = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				HotAirBalloon.minimumAltitudeTerrain = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				IOEntity.frameBudgetElectricHighPriorityMs = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				IOEntity.frameBudgetElectricLowPriorityMs = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				IOEntity.frameBudgetFluidMs = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				IOEntity.frameBudgetGenericMs = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				IOEntity.frameBudgetIndustrialMs = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				IOEntity.frameBudgetKineticMs = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				IOEntity.infiniteIoPower = str.ToBool();
			},
			Default = "False"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ItemManager.EnablePooling = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				LegacyShelter.max_shelters = str.ToInt();
			},
			Default = "1"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				MetalDetectorFlag.TimeoutDuration = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				MetalDetectorSource.AttemptsPerSubSourceSpawn = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				MetalDetectorSource.MinDistanceBetweenSubSources = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				MetalDetectorSource.Population = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				MetalDetectorSource.TimeoutDuration = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				NPCVendingMachine.DynamicPricingEnabled = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				NPCVendingMachine.MaximumPriceMultiplier = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				NPCVendingMachine.MinimumPriceMultiplier = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				NPCVendingMachine.PriceDecreaseAmount = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				NPCVendingMachine.PriceIncreaseAmount = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				NPCVendingMachine.PriceUpdateFrequencyBiWeekly = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				NPCVendingMachine.PriceUpdateFrequencyDefault = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				NPCVendingMachine.PriceUpdateFrequencyWeekly = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				NPCVendingMachine.StartingPriceMultiplier = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				PatrolHelicopterAI.flee_damage_percentage = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				PatrolHelicopterAI.monument_crash = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				PatrolHelicopterAI.use_danger_zones = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				PhysicsTumblingEntity.angular_drag_override = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				PhysicsTumblingEntity.drag_override = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				PhysicsTumblingEntity.max_tumbling_force = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				PhysicsTumblingEntity.min_tumbling_force = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				PhysicsTumblingEntity.player_impulse_multiplier = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				PhysicsTumblingEntity.tumbling_force_cone_angle = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				PhysicsTumblingEntity.velocity_threshold_for_tumbling_force = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				PlanterBox.outsideTestDistance = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				PlanterBoxStatic.FavourableGeneChance = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Radiation.materialToRadsRatio = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Radiation.water_inventory_damage = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Radiation.water_loot_damage = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RidableHorse.autoAvoidance = str.ToBool();
			},
			Default = "True"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RidableHorse.decayMinutes = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RidableHorse.dungTimeScale = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RidableHorse.groundAngleUpdateRate = str.ToFloat();
			},
			Default = "0.05"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RidableHorse.throttledGroundAngleUpdate = str.ToBool();
			},
			Default = "1"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Crocodile.Population = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Panther.Population = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				SenseComponent.maxRefreshIntervalSeconds = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				SenseComponent.minRefreshIntervalSeconds = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				TigerFSM.chargeRange = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				TigerSneakTelegraphGrowl.minAngle = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				TigerSneakTelegraphGrowl.minTimeBetweenGrowls = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				SamSite.autoreloaddelay = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Shield.InfiniteShieldBlock = str.ToBool();
			},
			Default = "False"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				SleepingBag.UseTeamLabels = str.ToBool();
			},
			Default = "True"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				SnakeHazard.Population = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				StashContainer.PlayerDetectionTickRate = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				StorageContainer.canRequireAuthIfNoLock = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				StorageContainer.corpseItemsSavedPercent = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				StorageContainer.dropCorpseOnDeath = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				TrainCar.killofftracktrains = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				TravellingVendor.alive_time_seconds = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				TravellingVendor.attempt_pullovers = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				TravellingVendor.max_speed = str.ToFloat();
			},
			Default = "5"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				TravellingVendor.should_destroy_buildings = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				TravellingVendor.should_spawn = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				TreeManager.CellSize = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				TreeManager.EnableTreeStreaming = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				TreeManager.PlayerBudgetMS = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				TreeManager.UpdateBudgetMS = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				TreeManager.UseLazySerialization = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				TriggerBase.UseExcludeLayers = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				TutorialIsland.EnforceTrespassChecks = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			Variable = true,
			GetOveride = () => TutorialIsland.OverrideTutorialLocation.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				TutorialIsland.SpawnTutorialIslandForNewPlayer = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				VineMountable.allowChaining = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				WaypointRace.raceTimeout = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				WildlifeHazard.ChanceToRepositionMultiplier = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				WildlifeHazard.ClientTickRate = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				WildlifeHazard.ReactionTimeMultiplier = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				WildlifeHazard.RepositionAttempts = str.ToInt();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				WildlifeHazard.RepositionRadiusMultiplier = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				WildlifeHazard.RepositionTimerMultiplier = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
