...
public class PlayerHelicopter : BaseHelicopter, IEngineControllerUser, IEntity, SamSite.ISamSiteTarget
{
	...
	private static readonly Translate.Phrase CantRepairUnGrounded = new Translate.Phrase("error_cannot_repair_ungrounded", "Cannot repair in flight, ground the vehicle first");
	...
	public override void DoRepair(BasePlayer player)
	{
		if (!IsGrounded())
		{
			OnRepairFailed(player, CantRepairUnGrounded);
		}
		else
		{
