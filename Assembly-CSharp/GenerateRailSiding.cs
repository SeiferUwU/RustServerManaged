	...
	public override void Process(uint seed)
	{
		...
		foreach (PathList rail3 in TerrainMeta.Path.Rails)
		{
			...
			for (int k = num2; k <= num3; k++)
			{
				...
				Vector3 vector4 = Vector3.Normalize(points3[num6 + 8] - points3[num6]);
				Vector3 vector5 = Vector3.Normalize(points3[num7] - points3[num7 - 8]);
				float num8 = Vector3.SignedAngle(vector4, to2, Vector3.up);
				float f = 0f - Vector3.SignedAngle(vector5, to3, Vector3.up);
