...
public class UserPersistance : IDisposable
{
	...
	public UserPersistance(string strFolder)
	{
		...
		deaths.Open(strFolder + "/player.deaths." + 8 + ".db");
		...
		identities.Open(strFolder + "/player.identities." + 8 + ".db");
		...
		playerState.Open(strFolder + "/player.states." + 274 + ".db");
