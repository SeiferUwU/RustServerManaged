	...
	private static void SortByDescending(ref NativeArray<int> colliders, ref NativeArray<int> counts, int leftIndex, int rightIndex)
	{
		...
		while (i <= num)
		{
			...
			if (i <= num)
			{
				...
				int num5 = (colliders[index] = num3);
				num5 = (reference[index2] = num4);
				index2 = i;
				reference = ref counts;
				index = num;
				num4 = counts[num];
				num3 = counts[i];
				num5 = (counts[index2] = num4);
				num5 = (reference[index] = num3);
				i++;
				num--;
			}
		}
	...
	private static void SortAscending(ref NativeArray<int> array, int leftIndex, int rightIndex)
	{
		...
		while (i <= num)
		{
			...
			if (i <= num)
			{
				...
				int num3 = array[num];
				int num4 = array[i];
				int num5 = (array[index] = num3);
				num5 = (array[index2] = num4);
				i++;
				num--;
			}
		}
