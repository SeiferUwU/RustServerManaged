		...
		using (TimeWarning.New("PlayerAttack", 50))
		{
			...
			if (flag8 && flag && !flag7)
			{
				...
				if (!flag9)
				{
					...
					{
						"Line of sight player (", shortPrefabName10, " on ", shortPrefabName11, ") ", null, null, null, null, null,
						null, null
					};
			...
			if (num16 == 0)
			{
				...
				{
					"Line of sight entity (", shortPrefabName12, " on ", shortPrefabName13, ") ", null, null, null, null, null,
					null, null, null, null
				};
