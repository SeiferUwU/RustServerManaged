...
public class MarchingCubesGenerator : IDisposable
{
	...
	public JobHandle ScheduleMarch()
	{
		...
		Facepunch.MarchingCubes.MarchJob jobData = new Facepunch.MarchingCubes.MarchJob
		{
			sampler = _sampler,
			vertices = vertices0,
			indices = indices0,
		...
		Facepunch.MarchingCubes.CleanupDuplicateVerticesJob jobData2 = new Facepunch.MarchingCubes.CleanupDuplicateVerticesJob
		{
