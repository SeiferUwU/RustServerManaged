		...
		using (TimeWarning.New("CarPhysics.FixedUpdate"))
		{
			...
			if (!rBody.IsSleeping())
			{
				...
				else
				{
					...
					int num4 = 0;
					float num5 = 0f;
					bool flag2 = !vehicleSettings.disableHandbrakes && !hasDriver && rBody.velocity.magnitude < 2.5f && (float)car.timeSinceLastPush > 2f && car.OnSurface != VehicleTerrainHandler.Surface.Frictionless;
