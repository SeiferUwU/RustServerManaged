...
public class CollateTrainTracks : ProceduralComponent
{
	...
	public override void Process(uint seed)
	{
		...
		static bool NodesConnect(Vector3 vector, Vector3 theirPos, Vector3 vector2, Vector3 theirTangent)
		{
			if (Vector3.SqrMagnitude(vector - theirPos) < 0.010000001f)
			{
				return Vector3.Angle(vector2, theirTangent) < 10f;
			}
			return false;
		}
	}
