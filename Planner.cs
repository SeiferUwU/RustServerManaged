...
public class Planner : HeldEntity
{
	...
	public virtual void PayForPlacement(BasePlayer player, Construction component)
	{
		...
		foreach (ItemAmount item in component.defaultGrade.CostToBuild())
		{
			...
			Facepunch.Rust.Analytics.Azure.LogResource(Facepunch.Rust.Analytics.Azure.ResourceMode.Consumed, "build_block", item.itemDef.shortname, (int)item.amount, null, null, safezone: false, null, player.userID);
		}
