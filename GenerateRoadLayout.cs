	...
	public override void Process(uint seed)
	{
		...
		while (list4.Count != 0 || list5.Count != 0)
		{
			if (list4.Count == 0)
			{
				...
				list4.AddRange(list5.Where((PathNode pathNode3) => pathNode3.monument == node3.monument));
				list5.RemoveAll((PathNode pathNode3) => pathNode3.monument == node3.monument);
			...
			list8.Clear();
			list8.AddRange(list4.Select((PathNode pathNode3) => pathNode3.node.point));
			list7.Clear();
			list7.AddRange(list3.Select((PathNode pathNode3) => pathNode3.node.point));
			list7.AddRange(list5.Select((PathNode pathNode3) => pathNode3.node.point));
			list7.AddRange(list6);
			PathFinder.Node node4 = pathFinder.FindPathUndirected(list7, list8, 100000);
			if (node4 == null)
			{
				PathNode node5 = list4[0];
				list5.AddRange(list4.Where((PathNode pathNode3) => pathNode3.monument == node5.monument));
				list4.RemoveAll((PathNode pathNode3) => pathNode3.monument == node5.monument);
				list5.Remove(node5);
				list3.Add(node5);
				continue;
			}
			...
			list2.Add(segment);
			PathNode node7 = list4.Find((PathNode pathNode3) => pathNode3.node.point == segment.start.point || pathNode3.node.point == segment.end.point);
			list5.AddRange(list4.Where((PathNode pathNode3) => pathNode3.monument == node7.monument));
			list4.RemoveAll((PathNode pathNode3) => pathNode3.monument == node7.monument);
			list5.Remove(node7);
			list3.Add(node7);
			PathNode pathNode2 = list5.Find((PathNode pathNode3) => pathNode3.node.point == segment.start.point || pathNode3.node.point == segment.end.point);
			if (pathNode2 != null)
			{
		...
		{
			PathSegment pathSegment = list2.Find((PathSegment pathSegment2) => pathSegment2.start.point == target.node.point || pathSegment2.end.point == target.node.point);
			if (pathSegment != null)
			{
