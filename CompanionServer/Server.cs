...
public static class Server
{
	...
	private static async Task CheckConnectivity()
	{
		...
		try
		{
			...
			{
				Debug.LogError("Failed to determine public IP address for Rust+ while running the connectivity test. Disabling Rust+ features because we wouldn't know what IP to tell Rust+ to connect to.");
				SetServerId(null);
			}
