			...
			public unsafe static IntPtr[] FatVtable_
			{
				get
				{
					...
					if (obj == null)
					{
						obj = new IntPtr[2]
						{
							(IntPtr)(delegate*<void*, void*>)(&S_GetPSig_),
							(IntPtr)(delegate*<void*, uint>)(&S_GetCSig_)
						};
						fatVtable_ = (IntPtr[]?)obj;
					}
					return (IntPtr[])obj;
					unsafe static uint S_GetCSig_(void* ptr__)
					{
						return ((StoredSigMethodDesc_64*)ptr__)->GetCSig();
					}
					unsafe static void* S_GetPSig_(void* ptr__)
					{
		...
		public struct FCallMethodDesc_64
		{
			...
			public unsafe static IntPtr[] FatVtable_
			{
				get
				{
					...
					if (obj == null)
					{
						obj = new IntPtr[1] { (IntPtr)(delegate*<void*, uint>)(&S_GetECallID_) };
						fatVtable_ = (IntPtr[]?)obj;
					}
					return (IntPtr[])obj;
					unsafe static uint S_GetECallID_(void* ptr__)
					{
		...
		public struct DynamicMethodDesc_64
		{
			...
			public unsafe static IntPtr[] FatVtable_
			{
				get
				{
					...
					if (obj == null)
					{
						obj = new IntPtr[1] { (IntPtr)(delegate*<void*, DynamicMethodDesc_ExtendedFlags>)(&S_GetFlags_) };
						fatVtable_ = (IntPtr[]?)obj;
					}
					return (IntPtr[])obj;
					unsafe static DynamicMethodDesc_ExtendedFlags S_GetFlags_(void* ptr__)
					{
