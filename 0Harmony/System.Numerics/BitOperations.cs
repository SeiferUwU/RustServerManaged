...
internal static class BitOperations
{
	...
	private static int Log2SoftwareFallback(uint value)
	{
		...
		value |= value >> 8;
		value |= value >> 16;
		return System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref MemoryMarshal.GetReference(Log2DeBruijn), (IntPtr)(int)(value * 130329821 >> 27));
	}
	...
	public static int PopCount(uint value)
	{
		...
		static int SoftwareFallback(uint num)
		{
			num -= (num >> 1) & 0x55555555;
			num = (num & 0x33333333) + ((num >> 2) & 0x33333333);
			num = ((num + (num >> 4)) & 0xF0F0F0F) * 16843009 >> 24;
			return (int)num;
		}
	}
	...
	public static int PopCount(ulong value)
	{
		...
		return SoftwareFallback(value);
		static int SoftwareFallback(ulong num)
		{
			num -= (num >> 1) & 0x5555555555555555L;
			num = (num & 0x3333333333333333L) + ((num >> 2) & 0x3333333333333333L);
			num = ((num + (num >> 4)) & 0xF0F0F0F0F0F0F0FL) * 72340172838076673L >> 56;
			return (int)num;
		}
	}
	...
	public static int TrailingZeroCount(uint value)
	{
		...
		return System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref MemoryMarshal.GetReference(TrailingZeroCountDeBruijn), (IntPtr)(int)((value & (0 - value)) * 125613361 >> 27));
	}
