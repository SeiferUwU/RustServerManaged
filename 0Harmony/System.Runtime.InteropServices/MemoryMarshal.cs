...
internal static class MemoryMarshal
{
	...
	public static void Write<T>(Span<byte> destination, ref T value) where T : struct
	{
		...
		System.Runtime.CompilerServices.Unsafe.WriteUnaligned(ref GetReference(destination), value);
	}
	...
	public static Span<byte> AsBytes<T>(Span<T> span) where T : struct
	{
		...
		return new Span<byte>(System.Runtime.CompilerServices.Unsafe.As<System.Pinnable<byte>>(span.Pinnable), span.ByteOffset, length);
	}
	...
	public static ReadOnlySpan<byte> AsBytes<T>(ReadOnlySpan<T> span) where T : struct
	{
		...
		int length = checked(span.Length * System.Runtime.CompilerServices.Unsafe.SizeOf<T>());
		return new ReadOnlySpan<byte>(System.Runtime.CompilerServices.Unsafe.As<System.Pinnable<byte>>(span.Pinnable), span.ByteOffset, length);
	}
	...
	public unsafe static ref T GetReference<T>(Span<T> span)
	{
		...
		return ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref span.Pinnable.Data, span.ByteOffset);
	}
	...
	public static Span<TTo> Cast<TFrom, TTo>(Span<TFrom> span) where TFrom : struct where TTo : struct
	{
		...
		checked
		{
			...
			return new Span<TTo>(System.Runtime.CompilerServices.Unsafe.As<System.Pinnable<TTo>>(span.Pinnable), span.ByteOffset, length);
		}
	}
	...
	public static ReadOnlySpan<TTo> Cast<TFrom, TTo>(ReadOnlySpan<TFrom> span) where TFrom : struct where TTo : struct
	{
		...
		{
			int length = (int)unchecked(checked(unchecked((long)span.Length) * unchecked((long)System.Runtime.CompilerServices.Unsafe.SizeOf<TFrom>())) / System.Runtime.CompilerServices.Unsafe.SizeOf<TTo>());
			return new ReadOnlySpan<TTo>(System.Runtime.CompilerServices.Unsafe.As<System.Pinnable<TTo>>(span.Pinnable), span.ByteOffset, length);
		}
	}
}
