...
internal struct HashCode
{
	...
	private static uint GenerateGlobalSeed()
	{
		...
		return System.Runtime.CompilerServices.Unsafe.ReadUnaligned<uint>(ref destination[0]);
	}
	...
	public void AddBytes(ReadOnlySpan<byte> value)
	{
		...
		ref byte reference2 = ref System.Runtime.CompilerServices.Unsafe.Add(ref reference, value.Length);
		while ((nint)System.Runtime.CompilerServices.Unsafe.ByteOffset(ref reference, ref reference2) >= 4)
		{
			Add(System.Runtime.CompilerServices.Unsafe.ReadUnaligned<int>(ref reference));
			reference = ref System.Runtime.CompilerServices.Unsafe.Add(ref reference, 4);
		}
