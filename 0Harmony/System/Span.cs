...
internal readonly ref struct Span<T>
{
	...
	public unsafe ref T this[int index]
	{
		...
		get
		{
			...
			if (_pinnable == null)
			{
				...
				return ref System.Runtime.CompilerServices.Unsafe.Add(ref System.Runtime.CompilerServices.Unsafe.AsRef<T>(byteOffset.ToPointer()), index);
			}
			return ref System.Runtime.CompilerServices.Unsafe.Add(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref _pinnable.Data, _byteOffset), index);
		}
	}

	internal System.Pinnable<T>? Pinnable => _pinnable;
	...
	public Span(T[]? array)
	{
		...
		_pinnable = System.Runtime.CompilerServices.Unsafe.As<System.Pinnable<T>>(array);
	...
	internal static Span<T> Create(T[]? array, int start)
	{
		...
		return new Span<T>(System.Runtime.CompilerServices.Unsafe.As<System.Pinnable<T>>(array), byteOffset, length);
	}
	...
	public unsafe ref T GetPinnableReference()
	{
		if (_length != 0)
		{
			...
			return ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref _pinnable.Data, _byteOffset);
		}
	...
	public unsafe void Clear()
	{
		...
		nuint byteLength = (UIntPtr)(ulong)((uint)length * System.Runtime.CompilerServices.Unsafe.SizeOf<T>());
		if ((System.Runtime.CompilerServices.Unsafe.SizeOf<T>() & (sizeof(IntPtr) - 1)) != 0)
		{
			...
			{
				System.SpanHelpers.ClearLessThanPointerSized(ref System.Runtime.CompilerServices.Unsafe.As<T, byte>(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref _pinnable.Data, _byteOffset)), byteLength);
			}
		}
		else if (System.SpanHelpers.IsReferenceOrContainsReferences<T>())
		{
			nuint pointerSizeLength = (UIntPtr)(ulong)(length * System.Runtime.CompilerServices.Unsafe.SizeOf<T>() / sizeof(IntPtr));
	...
	public unsafe void Fill(T value)
	{
		...
		{
			byte value2 = System.Runtime.CompilerServices.Unsafe.As<T, byte>(ref value);
			if (_pinnable == null)
			{
				IntPtr byteOffset = _byteOffset;
				System.Runtime.CompilerServices.Unsafe.InitBlockUnaligned(byteOffset.ToPointer(), value2, (uint)length);
			}
			else
			{
				System.Runtime.CompilerServices.Unsafe.InitBlockUnaligned(ref System.Runtime.CompilerServices.Unsafe.As<T, byte>(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref _pinnable.Data, _byteOffset)), value2, (uint)length);
			}
			return;
		}
		...
		{
			System.Runtime.CompilerServices.Unsafe.Add(ref source, i) = value;
			System.Runtime.CompilerServices.Unsafe.Add(ref source, i + 1) = value;
			System.Runtime.CompilerServices.Unsafe.Add(ref source, i + 2) = value;
			System.Runtime.CompilerServices.Unsafe.Add(ref source, i + 3) = value;
			System.Runtime.CompilerServices.Unsafe.Add(ref source, i + 4) = value;
			System.Runtime.CompilerServices.Unsafe.Add(ref source, i + 5) = value;
			System.Runtime.CompilerServices.Unsafe.Add(ref source, i + 6) = value;
			System.Runtime.CompilerServices.Unsafe.Add(ref source, i + 7) = value;
		}
		if (i < (length & -4))
		{
			System.Runtime.CompilerServices.Unsafe.Add(ref source, i) = value;
	...
	public static bool operator ==(Span<T> left, Span<T> right)
	{
		...
		{
			return System.Runtime.CompilerServices.Unsafe.AreSame(ref left.DangerousGetPinnableReference(), ref right.DangerousGetPinnableReference());
		}
		return false;
	}
