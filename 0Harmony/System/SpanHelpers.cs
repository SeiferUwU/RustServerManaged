...
internal static class SpanHelpers
{
	...
	public static int BinarySearch<T, TComparable>(ref T spanStart, int length, TComparable comparable) where TComparable : IComparable<T>
	{
		...
		{
			int num3 = num2 + num >>> 1;
			int num4 = comparable.CompareTo(System.Runtime.CompilerServices.Unsafe.Add(ref spanStart, num3));
			if (num4 == 0)
			{
				return num3;
			}
		...
		while (true)
		{
			...
			if (length >= 8)
			{
				...
				if (!reference.Equals(other))
				{
					...
					T other2 = System.Runtime.CompilerServices.Unsafe.Add(ref searchSpace, num + 1);
					...
					T other3 = System.Runtime.CompilerServices.Unsafe.Add(ref searchSpace, num + 2);
					...
					T other4 = System.Runtime.CompilerServices.Unsafe.Add(ref searchSpace, num + 3);
					if (!reference4.Equals(other4))
					{
						...
						T other5 = System.Runtime.CompilerServices.Unsafe.Add(ref searchSpace, num + 4);
						if (!reference5.Equals(other5))
						{
							...
							T other6 = System.Runtime.CompilerServices.Unsafe.Add(ref searchSpace, num + 5);
							if (!reference6.Equals(other6))
							{
								...
								T other7 = System.Runtime.CompilerServices.Unsafe.Add(ref searchSpace, num + 6);
								if (!reference7.Equals(other7))
								{
									...
									T other8 = System.Runtime.CompilerServices.Unsafe.Add(ref searchSpace, num + 7);
			...
			else
			{
				if (length >= 4)
				{
					...
					T other9 = System.Runtime.CompilerServices.Unsafe.Add(ref searchSpace, num);
					...
					T other10 = System.Runtime.CompilerServices.Unsafe.Add(ref searchSpace, num + 1);
					...
					T other11 = System.Runtime.CompilerServices.Unsafe.Add(ref searchSpace, num + 2);
					...
					T other12 = System.Runtime.CompilerServices.Unsafe.Add(ref searchSpace, num + 3);
				...
				while (true)
				{
					if (length > 0)
					{
						...
						T other13 = System.Runtime.CompilerServices.Unsafe.Add(ref searchSpace, num);
	...
	public static int LastIndexOf<T>(ref T searchSpace, T value, int length) where T : IEquatable<T>
	{
		while (true)
		{
			...
			if (length >= 8)
			{
				...
				T other2 = System.Runtime.CompilerServices.Unsafe.Add(ref searchSpace, length + 6);
				if (reference2.Equals(other2))
				{
					return length + 6;
				}
				...
				T other3 = System.Runtime.CompilerServices.Unsafe.Add(ref searchSpace, length + 5);
				if (reference3.Equals(other3))
				{
					return length + 5;
				}
				...
				T other4 = System.Runtime.CompilerServices.Unsafe.Add(ref searchSpace, length + 4);
				if (reference4.Equals(other4))
				{
					return length + 4;
				}
				...
				T other5 = System.Runtime.CompilerServices.Unsafe.Add(ref searchSpace, length + 3);
				if (reference5.Equals(other5))
				{
					goto IL_02fd;
				}
				...
				T other6 = System.Runtime.CompilerServices.Unsafe.Add(ref searchSpace, length + 2);
				if (reference6.Equals(other6))
				{
					goto IL_02f9;
				}
				...
				T other7 = System.Runtime.CompilerServices.Unsafe.Add(ref searchSpace, length + 1);
				if (reference7.Equals(other7))
				{
					goto IL_02f5;
				}
				...
				T other8 = System.Runtime.CompilerServices.Unsafe.Add(ref searchSpace, length);
				if (!reference8.Equals(other8))
				{
					continue;
				}
			...
			else
			{
				if (length >= 4)
				{
					...
					T other9 = System.Runtime.CompilerServices.Unsafe.Add(ref searchSpace, length + 3);
					if (reference9.Equals(other9))
					{
						goto IL_02fd;
					}
					...
					T other10 = System.Runtime.CompilerServices.Unsafe.Add(ref searchSpace, length + 2);
					if (reference10.Equals(other10))
					{
						goto IL_02f9;
					}
					...
					T other11 = System.Runtime.CompilerServices.Unsafe.Add(ref searchSpace, length + 1);
					if (reference11.Equals(other11))
					{
						goto IL_02f5;
					}
					...
					T other12 = System.Runtime.CompilerServices.Unsafe.Add(ref searchSpace, length);
					if (reference12.Equals(other12))
					{
						goto IL_02f3;
					}
				...
				do
				{
					if (length > 0)
					{
						...
						other13 = System.Runtime.CompilerServices.Unsafe.Add(ref searchSpace, length);
						continue;
					}
					return -1;
				}
		...
		if (!System.Runtime.CompilerServices.Unsafe.AreSame(ref first, ref second))
		{
			...
			while (true)
			{
				...
				if (length >= 8)
				{
					...
					T other = System.Runtime.CompilerServices.Unsafe.Add(ref second, num);
					if (reference.Equals(other))
					{
						...
						T other2 = System.Runtime.CompilerServices.Unsafe.Add(ref second, num + 1);
						if (reference2.Equals(other2))
						{
							...
							T other3 = System.Runtime.CompilerServices.Unsafe.Add(ref second, num + 2);
							if (reference3.Equals(other3))
							{
								...
								T other4 = System.Runtime.CompilerServices.Unsafe.Add(ref second, num + 3);
								if (reference4.Equals(other4))
								{
									...
									T other5 = System.Runtime.CompilerServices.Unsafe.Add(ref second, num + 4);
									if (reference5.Equals(other5))
									{
										...
										T other6 = System.Runtime.CompilerServices.Unsafe.Add(ref second, num + 5);
										if (reference6.Equals(other6))
										{
											...
											T other7 = System.Runtime.CompilerServices.Unsafe.Add(ref second, num + 6);
											if (reference7.Equals(other7))
											{
												...
												T other8 = System.Runtime.CompilerServices.Unsafe.Add(ref second, num + 7);
												if (reference8.Equals(other8))
												{
													num += 8;
													continue;
				...
				else
				{
					...
					T other9 = System.Runtime.CompilerServices.Unsafe.Add(ref second, num);
					if (reference9.Equals(other9))
					{
						...
						T other10 = System.Runtime.CompilerServices.Unsafe.Add(ref second, num + 1);
						if (reference10.Equals(other10))
						{
							...
							T other11 = System.Runtime.CompilerServices.Unsafe.Add(ref second, num + 2);
							if (reference11.Equals(other11))
							{
								...
								T other12 = System.Runtime.CompilerServices.Unsafe.Add(ref second, num + 3);
								if (reference12.Equals(other12))
								{
									num += 4;
									goto IL_0377;
				...
				while (length > 0)
				{
					...
					T other13 = System.Runtime.CompilerServices.Unsafe.Add(ref second, num);
					if (reference13.Equals(other13))
					{
						num++;
						length--;
	...
	public static int SequenceCompareTo<T>(ref T first, int firstLength, ref T second, int secondLength) where T : IComparable<T>
	{
		...
		for (int i = 0; i < num; i++)
		{
			int num2 = System.Runtime.CompilerServices.Unsafe.Add(ref first, i).CompareTo(System.Runtime.CompilerServices.Unsafe.Add(ref second, i));
			if (num2 != 0)
			{
				return num2;
			}
