...
public static class ItemSearchUtils
{
	...
	{
		if (checkItemIsValid && (!(target.isRedirectOf != null) || target.redirectVendingBehaviour != ItemDefinition.RedirectVendingBehaviour.ListAsUniqueItem) && target.Hidden() && !target.vehicleItem)
		{
			return false;
		}
