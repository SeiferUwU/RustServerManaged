...
[assembly: AssemblyDescription("Core component for the Oxide modding framework")]
[assembly: AssemblyFileVersion("2.0.4138.0")]
[assembly: AssemblyInformationalVersion("2.0.4138")]
[assembly: AssemblyProduct("Oxide.Core")]
[assembly: AssemblyTitle("Oxide.Core")]
[assembly: AssemblyMetadata("RepositoryUrl", "https://github.com/OxideMod/Oxide.Core")]
[assembly: AssemblyMetadata("GitBranch", "master")]
[assembly: AssemblyVersion("2.0.4138.0")]
...
namespace Oxide.Plugins
{
	public static class ExtensionMethods
	{
		...
		{
			return Oxide.Core.Libraries.Covalence.Formatter.ToPlaintext(text);
		}
		...
		{
			return array[Oxide.Core.Random.Range(0, array.Length)];
		}
...
namespace Oxide.Core
{
	...
	public static class RemoteLogger
	{
		...
		private static readonly Oxide.Core.Libraries.Timer Timers = Interface.Oxide.GetLibrary<Oxide.Core.Libraries.Timer>();
...
namespace Oxide.Core.Plugins
{
	...
	public abstract class PluginLoader
	{
		...
		protected void LoadPlugin(Plugin plugin, bool waitingForAccess = false)
		{
			...
			catch (IOException)
			{
				...
				Interface.Oxide.GetLibrary<Oxide.Core.Libraries.Timer>().Once(0.5f, delegate
				{
	...
	public sealed class PluginManager
	{
		...
		public Oxide.Core.Logging.Logger Logger { get; private set; }
...
namespace Oxide.Core.Plugins.Watchers
{
	...
	public sealed class FSWatcher : PluginChangeWatcher
	{
		private class QueuedChange
		{
			...
			internal Oxide.Core.Libraries.Timer.TimerInstance timer;
		}
		...
		private Oxide.Core.Libraries.Timer timers;
		...
		public FSWatcher(string directory, string filter)
		{
			...
			timers = Interface.Oxide.GetLibrary<Oxide.Core.Libraries.Timer>();
		...
		public class WebRequest
		{
			...
			public void Start()
			{
				try
				{
					...
					if (!request.RequestUri.IsLoopback && IPAddress.TryParse(Interface.Oxide.Config.Options.WebRequestIP, out var address))
					{
...
namespace Oxide.Core.Libraries.Covalence
{
	...
	public class Covalence : Library
	{
		...
		private readonly Oxide.Core.Logging.Logger logger;
