...
public class ItemListTools : MonoBehaviour
{
	...
	public void FilterItems(string searchText)
	{
		...
		foreach (ItemDefinition item in obj)
		{
			...
			{
				GameObject obj2 = Object.Instantiate(itemButtonPrefab, itemButtonParent);
				...
				obj2.GetComponentInChildren<ItemButtonTools>().backgroundImage.enabled = item != null && !item.IsAllowed(EraRestriction.Default);
				num++;
				if (num >= 160)
				{
					break;
