...
public class FullServerDemos
{
	...
	private void FlushServerDemo(DateTime endOfChunk)
	{
		...
		if (fileStream != null)
		{
			if (debugJson != null)
			{
				jsonDebugWriter.WriteEndArray();
				jsonDebugWriter.Close();
				debugWriter.Close();
	...
	private void SetupNextDemoChunk(DateTime startTime)
	{
		...
		if (serializeDebugJson)
		{
			...
			jsonDebugWriter = new JsonTextWriter(debugWriter);
			jsonDebugWriter.WriteStartArray();
	...
	private void SaveChunkHeader(DemoChunkHeader header)
	{
		...
		string contents = JsonConvert.SerializeObject(header, Formatting.Indented);
	...
	private void WriteDebug(long index, long start, long end, ulong timestamp, long connectionsLength, ushort connectionCount)
	{
		...
		debugSerializer.Serialize(jsonDebugWriter, debugEntry);
	}
}
	...
	private static MonoScriptData Get()
	{
		return new MonoScriptData
		{
			FilePathsData = new byte[1463]
			{
				...
				117, 103, 105, 110, 115, 92, 70, 97, 99, 101,
				112, 117, 110, 99, 104, 46, 78, 101, 116, 119,
				111, 114, 107, 92, 77, 101, 115, 115, 97, 103,
				101, 46, 99, 115, 0, 0, 0, 1, 0, 0,
				0, 44, 92, 65, 115, 115, 101, 116, 115, 92,
				80, 108, 117, 103, 105, 110, 115, 92, 70, 97,
				99, 101, 112, 117, 110, 99, 104, 46, 78, 101,
				116, 119, 111, 114, 107, 92, 78, 101, 116, 82,
				101, 97, 100, 46, 99, 115, 0, 0, 0, 3,
				0, 0, 0, 48, 92, 65, 115, 115, 101, 116,
				115, 92, 80, 108, 117, 103, 105, 110, 115, 92,
				70, 97, 99, 101, 112, 117, 110, 99, 104, 46,
				78, 101, 116, 119, 111, 114, 107, 92, 78, 101,
				116, 119, 111, 114, 107, 97, 98, 108, 101, 46,
				99, 115, 0, 0, 0, 1, 0, 0, 0, 45,
				92, 65, 115, 115, 101, 116, 115, 92, 80, 108,
				117, 103, 105, 110, 115, 92, 70, 97, 99, 101,
				112, 117, 110, 99, 104, 46, 78, 101, 116, 119,
				111, 114, 107, 92, 78, 101, 116, 87, 114, 105,
				...
				101, 116, 119, 111, 114, 107, 92, 80, 97, 99,
				107, 101, 116, 80, 114, 111, 102, 105, 108, 101,
				114, 46, 99, 115, 0, 0, 0, 1, 0, 0,
				0, 45, 92, 65, 115, 115, 101, 116, 115, 92,
				80, 108, 117, 103, 105, 110, 115, 92, 70, 97,
				99, 101, 112, 117, 110, 99, 104, 46, 78, 101,
				116, 119, 111, 114, 107, 92, 83, 101, 110, 100,
				73, 110, 102, 111, 46, 99, 115, 0, 0, 0,
				4, 0, 0, 0, 43, 92, 65, 115, 115, 101,
				116, 115, 92, 80, 108, 117, 103, 105, 110, 115,
				92, 70, 97, 99, 101, 112, 117, 110, 99, 104,
				46, 78, 101, 116, 119, 111, 114, 107, 92, 83,
				101, 114, 118, 101, 114, 46, 99, 115, 0, 0,
				0, 2, 0, 0, 0, 42, 92, 65, 115, 115,
				101, 116, 115, 92, 80, 108, 117, 103, 105, 110,
				0, 0, 0, 0, 13, 78, 101, 116, 119, 111,
				114, 107, 124, 83, 116, 97, 116, 115, 0, 0,
				0, 0, 18, 78, 101, 116, 119, 111, 114, 107,
				46, 83, 116, 97, 116, 115, 124, 78, 111, 100,
				101, 0, 0, 0, 0, 27, 78, 101, 116, 119,
				111, 114, 107, 46, 86, 105, 115, 105, 98, 105,
				108, 105, 116, 121, 124, 80, 114, 111, 118, 105,
				100, 101, 114, 0, 0, 0, 0, 29, 78, 101,
				116, 119, 111, 114, 107, 46, 86, 105, 115, 105,
				98, 105, 108, 105, 116, 121, 124, 83, 117, 98,
				115, 99, 114, 105, 98, 101, 114, 0, 0, 0,
				0, 24, 78, 101, 116, 119, 111, 114, 107, 46,
				86, 105, 115, 105, 98, 105, 108, 105, 116, 121,
				124, 71, 114, 111, 117, 112, 0, 0, 0, 0,
				26, 78, 101, 116, 119, 111, 114, 107, 46, 86,
				105, 115, 105, 98, 105, 108, 105, 116, 121, 124,
...
namespace Network
{
	...
	public class Networkable : Pool.IPooled
	{
		...
		public void StartSubscriber()
		{
			if (subscriber != null)
			{
				UnityEngine.Debug.Log("BecomeSubscriber called twice!");
				return;
			}
		...
		{
			UnityEngine.Debug.Assert(sv != null, "SV IS NULL");
			UnityEngine.Debug.Assert(sv.visibility != null, "sv.visibility IS NULL");
	...
	public class NetWrite : Stream, Pool.IPooled, IStreamWriter
	{
		...
		public void BytesWithSize(byte[] b, int length, bool variableLength = false)
		{
			...
			{
				WriteUInt32(0u, variableLength);
				UnityEngine.Debug.LogError("BytesWithSize: Too big " + length);
			}
			else
			{
	...
	public abstract class Server : BaseNetwork
	{
		...
		public ulong TakeUID()
		{
			...
			{
				UnityEngine.Debug.LogError("TakeUID - ran out of available UIDs! Cannot continue running this save file.");
			...
			{
				UnityEngine.Debug.LogError("TakeUID - hitting ceiling limit! " + lastValueGiven);
			}
			else if (lastValueGiven > 18446744072859551615uL && lastValueGiven % 100000 == 0L)
			{
				UnityEngine.Debug.LogError("TakeUID - approaching ceiling limit! " + lastValueGiven);
			}
			lastValueGiven++;
			return lastValueGiven;
		}
...
namespace Network.Visibility
{
	...
	public class Subscriber : Pool.IPooled
	{
		...
		public Group Subscribe(Group group)
		{
			...
			{
				UnityEngine.Debug.LogWarning("Subscribe: Network Group already subscribed!");
				return null;
			}
	...
	public class Group : IDisposable
	{
		...
		public void Join(Networkable nw)
		{
			if (networkables != null)
			{
				...
				{
					UnityEngine.Debug.LogWarning("Insert: Network Group already contains networkable!");
				}
				else
				{
					networkables.Add(nw);
		...
		public void Leave(Networkable nw)
		{
			if (networkables != null)
			{
				if (!networkables.Contains(nw))
				{
					UnityEngine.Debug.LogWarning("Leave: Network Group doesn't contain networkable!");
				}
				else
				{
	...
	public class Manager : IDisposable
	{
		...
		public Manager(Provider p)
		{
			...
			{
				UnityEngine.Debug.LogWarning("SetProvider should be called before anything else! " + groups.Count + " groups have already been registered!");
			}
			provider = p;
		}
