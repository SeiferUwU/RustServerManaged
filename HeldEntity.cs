...
public class HeldEntity : BaseEntity
{
	...
	public void UpdateHeldItemVisibility()
	{
		...
		{
			bool flag2 = GetOwnerPlayer().GetHeldEntity() == this || IsShield;
	...
	public void UpdateShieldState(bool bHeld)
	{
		...
		if (canBeUsedWithShield && anyBackpack != null && anyBackpack.info.TryGetComponent<ItemModShield>(out var _))
		{
